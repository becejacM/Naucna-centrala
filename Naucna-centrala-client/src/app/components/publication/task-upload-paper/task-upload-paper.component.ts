...
@Component({
  selector: 'app-task-upload-paper',
  templateUrl: './task-upload-paper.component.html',
  styleUrls: ['./task-upload-paper.component.css']
})
export class TaskUploadPaperComponent implements OnInit {
  ...
  completeTask(o?: any) {
    ...
    console.log("milkaaaa*************dddddddd "+this.taskDetails["filename"]);
