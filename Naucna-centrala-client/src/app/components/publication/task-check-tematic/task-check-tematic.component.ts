...
@Component({
  selector: 'app-task-check-tematic',
  templateUrl: './task-check-tematic.component.html',
  styleUrls: ['./task-check-tematic.component.css']
})
export class TaskCheckTematicComponent implements OnInit {
